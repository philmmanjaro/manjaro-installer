...
public:
    ...
    Global::Location getCurrentLocation() { return currentLocation; }
    void setCurrentLocation(QString region, QString zone);
    void setCurrentLocation(Global::Location location);

signals:
    void locationChanged(Global::Location location);
